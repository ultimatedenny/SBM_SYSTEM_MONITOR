...
<body class="nk-body bg-lighter npc-general has-sidebar ">
                                ...
                                <div class="nk-msg">
                                    ...
                                    <div class="nk-msg-body bg-white profile-shown">
                                        <div class="nk-msg-head">
                                            <h4 class="title d-none d-lg-block">Unable to select currency when booking a room</h4>
                                            ...
                                            <div class="nk-reply-item">
                                                ...
                                                <div class="nk-reply-body">
                                                    <div class="nk-reply-entry entry">
                                                        <p>Hello team,</p>
                                                        <p>I am facing problem as i can not select a room for booking. Can you guys let me know what i am doing doing wrong? Please check attached files.</p>
                                                        ...
                                                        <div class="row text-center g-1">
                                                            <div class="col-4">
                                                                <div class="profile-stats">
                                                                    <span class="amount text-purple">30</span>
                                                                    <span class="sub-text">Total Order</span>
                                                                </div>
                                                            </div>
                                                            <div class="col-4">
                                                                <div class="profile-stats">
                                                                    <span class="amount text-purple">25</span>
                                                                    <span class="sub-text">Complete</span>
                                                                </div>
                                                            </div>
                                                            <div class="col-4">
                                                                <div class="profile-stats">
                                                                    <span class="amount text-purple">5</span>
                                                    ...
                                                    <div class="card-inner">
                                                        <div class="aside-wg">
                                                            ...
                                                            <ul class="user-contacts">
                                                                <li>
                                                                    <em class="icon ni ni-mail text-orange"></em><span>info@softnio.com</span>
                                                                </li>
                                                                <li>
                                                                    <em class="icon ni ni-call text-success"></em><span>+938392939</span>
                                                                </li>
                                                                <li>
                                                                    <em class="icon ni ni-map-pin text-pink"></em><span>1134 Ridder Park Road <br>San Fransisco, CA 94851</span>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <div class="aside-wg">
    ...
    <script src="./assets/js/apps/messages.js?ver=3.2.2"></script>
</body>
