...
<head>
    ...
    <!-- Page Title  -->
    <title>Warehouse List | CRM | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                            ...
                                            <div class="toggle-wrap nk-block-tools-toggle">
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        <li class="nk-block-tools-opt"><a class="btn btn-primary" data-bs-toggle="modal" href="#addWarehouse"><em class="icon ni ni-plus"></em><span>Add Warehouse</span></a></li>
                                                    </ul>
                                                </div>
                                            </div><!-- .toggle-wrap -->
                                        </div><!-- .nk-block-head-content -->
                                                                        ...
                                                                        <div class="drodown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                    ...
                                                                                    <li><a data-bs-toggle="modal" href="#editWarehouse"><em class="icon ni ni-edit"></em><span>Edit Info</span></a></li>
                                                                                    <li><a data-bs-toggle="modal" href="#deleteWarehouse"><em class="icon ni ni-delete"></em><span>Delete</span></a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                    </li>
