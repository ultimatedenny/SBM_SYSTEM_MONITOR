...
<body class="nk-body bg-lighter npc-general has-sidebar ">
    ...
    <!-- @@ Add Card Modal @e -->
    <div class="modal fade" role="dialog" id="add-card">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <a href="#" class="close" data-bs-dismiss="modal"><em class="icon ni ni-cross-sm"></em></a>
                <div class="modal-body modal-body-lg">
                    <h5 class="title mb-4">Add New Card</h5>
                    <div class="row gy-3 gx-3">
                        <div class="col-12">
                            <div class="form-group">
                                <label class="form-label" for="card-number">Card Number</label>
                                <input type="text" class="form-control form-control-lg" id="card-number" value="" placeholder="0000 0000 0000 0000">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                                <label class="form-label" for="cardholder-name">Cardholder Name</label>
                                <input type="text" class="form-control form-control-lg" id="cardholder-name" placeholder="Name on your card">
                            </div>
                        </div>
                        <div class="col-7">
                            <div class="form-group">
                                <label class="form-label" for="exp-date">Expiry Date</label>
                                <input type="number" class="form-control form-control-lg" id="exp-date" placeholder="MM/YYYY">
                            </div>
                        </div>
                        <div class="col-5">
                            <div class="form-group">
                                <label class="form-label" for="cvv/cvc">CVV/CVC</label>
                                <input type="number" class="form-control form-control-lg" id="cvv/cvc" value="" placeholder="CVV/CVC">
                            </div>
                        </div>
                        <div class="col-12">
                            <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                <li>
                                    <a href="#" class="btn btn-lg btn-primary" data-bs-dismiss="modal">Add Card</a>
                                </li>
                            </ul>
                        </div>
                    </div>
