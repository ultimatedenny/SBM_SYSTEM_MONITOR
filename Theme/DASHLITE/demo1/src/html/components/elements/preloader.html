...
<head>
    ...
    <!-- Page Title  -->
    <title>Preloader | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">Preloader</h2>
                                            <div class="nk-block-des">
                                                <p class="lead">Examples for adding custom Preloader with CSS and JavaScript using CSS3 for animations.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                ...
                                                <div class="nk-block-des">
                                                    <p>Use <code>.js-preloader</code> div before closing html. then change animation class on <code>.loading-animation</code> div, for example <code>.tri-ring, .duo-pulse</code> etc.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <ul class="d-flex flex-wrap g-3">
                                                    <li>
                                                        <h6 class="overline-title">Three Ring</h6>
                                                        <div class="tri-ring"></div>
                                                    </li>
                                                    <li>
                                                        <h6 class="overline-title">Double Pulse</h6>
                                                        <div class="duo-pulse"></div>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div><!-- .card-preview -->
                                        <div class="code-block">
                                            ...
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#Preloader1" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="Preloader1">
