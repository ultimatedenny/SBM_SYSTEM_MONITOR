...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/libs/fontawesome-icons.css?ver=3.2.2">
    <link rel="stylesheet" href="./assets/css/libs/themify-icons.css?ver=3.2.2">
    <link rel="stylesheet" href="./assets/css/libs/bootstrap-icons.css?ver=3.2.2">
</head>
