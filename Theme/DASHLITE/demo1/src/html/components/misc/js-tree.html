...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/libs/jstree.css?ver=3.2.2">
</head>
...
&lt;/div&gt;
    ...
    <script src="./assets/js/libs/jstree.js?ver=3.2.2"></script>
    <script src="./assets/js/example-tree.js?ver=3.2.2"></script>
</body>
